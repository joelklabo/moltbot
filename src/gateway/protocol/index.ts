...
import {
  ...
  type DiagnosticsOtelTestParams,
  DiagnosticsOtelTestParamsSchema,
...
export const validateDiagnosticsOtelTestParams = ajv.compile<DiagnosticsOtelTestParams>(
  DiagnosticsOtelTestParamsSchema,
);
